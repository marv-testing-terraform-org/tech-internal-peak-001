...
| <a name="input_github_repo_advanced_security_status"></a> [github\_repo\_advanced\_security\_status](#input\_github\_repo\_advanced\_security\_status) | Set to enabled to turn on advanced security features for the repository. This is only applicable for private and internal repositories, as advanced security is always enabled for public repositories. | `string` | `"enabled"` | no |
...
| <a name="input_github_repo_team_access"></a> [github\_repo\_team\_access](#input\_github\_repo\_team\_access) | Teams mapped to repository permissions | <pre>object({<br/>    admin = optional(list(string), [])<br/>    #maintain = optional(list(string), [])<br/>    push = optional(list(string), [])<br/>    pull = optional(list(string), [])<br/>  })</pre> | n/a | yes |
...
| Name | Description |
|------|-------------|
| <a name="output_out_github_repo_repository_name"></a> [out\_github\_repo\_repository\_name](#output\_out\_github\_repo\_repository\_name) | The name of the created GitHub repository. |
| <a name="output_out_github_repo_repository_url"></a> [out\_github\_repo\_repository\_url](#output\_out\_github\_repo\_repository\_url) | The URL of the created GitHub repository. |
| <a name="output_out_github_repo_team_ids"></a> [out\_github\_repo\_team\_ids](#output\_out\_github\_repo\_team\_ids) | A map of team names to their GitHub team IDs. |
<!-- END_TF_DOCS -->